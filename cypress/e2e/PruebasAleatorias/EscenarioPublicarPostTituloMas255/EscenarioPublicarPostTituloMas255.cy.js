...
import CrearPostTituloMas255 from "./EscenarioPublicarPostTituloMas255";
    ...
    context('Given I access the search engine page', () => {
        ...
        context('When I write and login in the page', () => {
            ...
            it("Then content and title should not be empty", function () {
                ...
                const crearPostTituloMas255= new CrearPostTituloMas255();
                ingreso.ingresoPost();
                crearPostTituloMas255.crearPostTituloMas255();
            })
        })
    })
})