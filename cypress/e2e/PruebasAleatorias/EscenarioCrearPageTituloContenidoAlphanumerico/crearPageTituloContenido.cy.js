...
import TituloyContenidoAlphanumeriocPage from "./tituloyContenidoAlphanumericoPage";
    ...
    context('Given I access the search engine page', () => {
        ...
        context('When I write and login in the page', () => {
            ...
            it("Then content and title should not be empty", function () {
                ...
                const tituloContenidoPage = new TituloyContenidoAlphanumeriocPage();
                ingreso.ingresoPage();
                tituloContenidoPage.tituloyContenidoAlphanumericoPage();
            })
        })
    })
})