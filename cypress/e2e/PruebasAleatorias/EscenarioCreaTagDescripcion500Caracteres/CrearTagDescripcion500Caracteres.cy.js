...
import CrearTagDescripcion500Caracteres from "./CrearTagDescripcion500Caracteres";
    ...
    context('Given I access the search engine page', () => {
        ...
        context('When I write and login in the page', () => {
            ...
            it("Then content and title should not be empty", function () {
                ...
                const crearTagDescripcion500Caracteres = new CrearTagDescripcion500Caracteres();
                ingreso.ingresoTag();
                crearTagDescripcion500Caracteres.crearTagDescripcion500Caracteres();
            })
        })
    })
})