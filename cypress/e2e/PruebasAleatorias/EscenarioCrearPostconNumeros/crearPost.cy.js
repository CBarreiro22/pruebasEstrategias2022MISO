...
import TituloyContenidoNumero from "./tituloyContenidoNumero";
    ...
    context('Given I access the search engine page', () => {
        ...
        context('When I write and login in the page', () => {
            ...
            it("Then content and title should not be empty", function () {
                ...
                const tituloContenidoNumeroPost = new TituloyContenidoNumero();
                ingreso.ingresoPost();
                tituloContenidoNumeroPost.tituloyContenidoNumeroPost();
            })
        })
    })
})