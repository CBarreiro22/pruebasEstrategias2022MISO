...
class TituloyContenidoNumericoPage {
    tituloyContenidoNumericoPage() {
        let content=faker.random.numeric(12)
        let content2=faker.random.numeric(300)
...
export default TituloyContenidoNumericoPage