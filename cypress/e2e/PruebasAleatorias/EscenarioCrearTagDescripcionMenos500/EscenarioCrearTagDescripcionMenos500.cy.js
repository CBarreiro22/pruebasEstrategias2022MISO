...
import CrearTagDescripcionMenos500 from "./EscenarioCrearTagDescricionMenos500";
    ...
    context('Given I access the search engine page', () => {
        ...
        context('When I write and login in the page', () => {
            ...
            it("Then content and title should not be empty", function () {
                ...
                const crearTituloDescripcionMenos500 = new CrearTagDescripcionMenos500();
                ingreso.ingresoTag();
                crearTituloDescripcionMenos500.crearTituloDescripcionMenos500();
            })
        })
    })
})