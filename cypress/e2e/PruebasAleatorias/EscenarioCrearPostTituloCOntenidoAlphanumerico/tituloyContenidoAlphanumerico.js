...
class TituloyContenidoAlphanumerico {
    tituloyContenidoAlphanumericoPost() {
        let content=faker.random.alphaNumeric(5)
        let content2=faker.random.alphaNumeric(400)
        cy.wait(3000)
...
export default TituloyContenidoAlphanumerico