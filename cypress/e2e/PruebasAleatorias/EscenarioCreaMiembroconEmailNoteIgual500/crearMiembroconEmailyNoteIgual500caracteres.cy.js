...
import SoloEmailCorrectoyNoteIgual500Carateres from "./emailyNoteIgual500Caracteres";
    ...
    context('Given I access the search engine page', () => {
        ...
        context('When I write and login in the page', () => {
            ...
            it("Then the title and content should be empty", function () {
                ...
                const soloEmailyNoteIgual500 = new SoloEmailCorrectoyNoteIgual500Carateres();
                ingreso.ingresoMiembro();
                soloEmailyNoteIgual500.soloEmailCorrectoyNoteIgual500CarateresMiembro();
            })
        })
    })
})