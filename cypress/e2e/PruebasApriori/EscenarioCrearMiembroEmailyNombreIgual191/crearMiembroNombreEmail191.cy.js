...
import CrearMiembroEmailNombreIgual191 from "./crearMiembroEmailNombreIgual191";
    ...
    context('Given I access the search engine page', () => {
        ...
        context('When I write and login in the page', () => {
            ...
            it("Then the title and content should be empty", function () {
                ...
                const crearMiembro = new CrearMiembroEmailNombreIgual191();
                ingreso.ingresoMiembro();
                crearMiembro.crearMiembroEmailNombreIgual191();
            })
        })
    })
})