...
import SoloEmailCorrectoyNote500Carateres from "./emailyNotemas500Caracteres";
    ...
    context('Given I access the search engine page', () => {
        ...
        context('When I write and login in the page', () => {
            ...
            it("Then the title and content should be empty", function () {
                ...
                const soloEmailyNote500 = new SoloEmailCorrectoyNote500Carateres();
                ingreso.ingresoMiembro();
                soloEmailyNote500.soloEmailCorrectoyNote500CarateresMiembro();
            })
        })
    })
})