...
class DescripcionContenidomas500caracteres {
    DescripcionContenidoMas500Tag() {
        let content = randomData['character_field'];
        let content2 = randomData['contenido_mas_500'];
        cy.wait(3000)
...
export default DescripcionContenidomas500caracteres