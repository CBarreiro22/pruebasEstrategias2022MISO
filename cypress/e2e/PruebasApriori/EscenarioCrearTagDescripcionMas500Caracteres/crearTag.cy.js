...
import TituloyContenidoMas500 from "./crearTagDescripcionMas500";
    ...
    context('Given I access the search engine page', () => {
        ...
        context('When I write and login in the page', () => {
            ...
            it("Then content and title should not be empty", function () {
                ...
                const descripContenidoTag = new TituloyContenidoMas500();
                ingreso.ingresoTag();
                descripContenidoTag.DescripcionContenidoMas500Tag();
            })
        })
    })
})